...
onnxmodel_path='./Model_resnet18_withpretrain_fer2013_scheduler.onnx'
...
def main():
    ...
    transforms = trns.Compose([trns.Resize((48, 48)),
                               trns.ToTensor()])
    ...
    while True:
        ...
        tmp = image_tensor[0,:,:]*0.299+image_tensor [1,:,:]*0.587+image_tensor [2,:,:]*0.114
        image_tensor[0,:,:]=tmp
        image_tensor[1,:,:]=tmp
        image_tensor[2,:,:]=tmp
